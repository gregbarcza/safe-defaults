...
describe('deep-defaults', function () {
  ...
  it('should handle Object pollution', function () {
    let a = deepDefaults({}, JSON.parse('{"__proto__": {"objectPollution": true}}'))
    assert({}.objectPollution === undefined, 'objectPollution should be undefined')
  })
